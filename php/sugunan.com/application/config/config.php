...
|
*/
$config['base_url']	= 'http://www.sugunan.com/';
/*
 *URL redirect
 */
$pageURL = 'http';
...
|--------------------------------------------------------------------------
|
| This is the system base path.
|
|
*/
$config['docroot']	= '/home/sugunan/public_html/';
...
|--------------------------------------------------------------------------
|
| URL to your theme root. Typically this will be your base theme URL,
| WITH a trailing slash:
|
...
|
*/
$config['template_url']	= $config['base_url'].'theme/cv/';
...
|
*/
$config['index_page'] = $config['base_url']."index.php?/";
